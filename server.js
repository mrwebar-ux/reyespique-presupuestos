...
p{margin:0}
.doc-summary-block{margin-top:8px;margin-left:auto;width:38%;min-width:320px;max-width:380px;break-inside:avoid;page-break-inside:avoid}
.doc-summary-table{border:1px solid #d1d5db;background:#fff}
...
.doc-totals-strip{margin-top:8px;border:1px solid #d1d5db;display:grid;grid-template-columns:1fr 1fr 1.2fr;background:#fff;break-inside:avoid;page-break-inside:avoid}
...
.doc-terms-wrap{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:10px;break-inside:avoid;page-break-inside:avoid}
.doc-terms-box{border:1px solid #d1d5db;background:#fff;break-inside:avoid;page-break-inside:avoid}
.doc-terms-box .terms-title{background-image:var(--blue-grad);color:#fff;padding:4px 8px;font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:.01em;white-space:nowrap}
.doc-terms-box .terms-body{padding:6px 8px}
.doc-terms-item{margin:0 0 4px}
...
<div class="doc-section">
  <div class="doc-terms-wrap">
    ...
    <div class="doc-terms-box">
      <div class="terms-title">Garantías y Continuidad Operativa</div>
      <div class="terms-body">
